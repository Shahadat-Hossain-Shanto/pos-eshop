...
{
    public function show($employeeId, $monthName){

        $salaries = SalaryEmployee::where([
        ...
        $salary_month=$salaries->salary_month;
        ...
        return view('salary/salary-pay-slip', ['employee_name' => $employee_name, 'addition' => $additions,  'net_payment'=>$net_pay,
         'absent'=>$absent,'salary_month'=>$salary_month, 'absentDeduction'=>$absentDeduction, 'basic_pay'=>$basic_pay,
          'department'=>$department , 'designation'=>$designation, 'benefits_add'=>$benefits_add, 'benefits_deduct'=>$benefits_deduct,
