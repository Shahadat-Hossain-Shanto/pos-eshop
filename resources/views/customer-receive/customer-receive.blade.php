      			...
      			<div class="col-lg-12">
          			<div class="card card-primary">
			            <div class="card-header">
			                <h5 class="m-0"><strong><i class="fas fa-receipt"></i> CUSTOMER RECEIVE</strong></h5>
			            </div>
	          				...
	          				<div class="">
	          					...
	          					<div class="form-group row">
							    	...
							    	<div class="col-sm-4">
							     	...
							     	<label for="ordernumber" class="col-sm-1 col-form-label text-right" style="font-weight: normal;">Order Number<span class="text-danger"><strong></strong></span></label>
							    	<div class="col-sm-4">
								      <input class="form-control w-75" type="text" name="ordernumber" id="ordernumber" placeholder="e.g. 16456935984756, 19458535984987">
								    </div>
							  	</div>
