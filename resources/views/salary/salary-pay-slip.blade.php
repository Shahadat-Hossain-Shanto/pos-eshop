                ...
                <div class="col-lg-6">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h5 class="m-0"><strong> SALARY PAY SLIP</strong></h5>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="text-left">
                                                ...
                                                <h6 class=""><b>Pay Month: </b>{{ $salary_month}}</h6>
...
<script type="text/javascript" src="{{asset('js/salary-pay-slip.js')}}"></script>
