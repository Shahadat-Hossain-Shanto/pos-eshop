...
@section('title', 'Store Stock Report (Variant Wise)')
            ...
            <div class="row">
	          	<div class="col-lg-12">
		              ...
		              <div class="card-header">
		                	<h5 class="m-0"><strong><i class="fas fa-file-contract"></i> STORE STOCK (VARIANT WISE)</strong></h5>
		              </div>
		              <div class="card-body">
                        <div class="row">
                            <div class="col-6">
...
<script type="text/javascript" src="js/store-stock-report.js"></script>
@endsection
