...
<div class='row'>
	          					<div class="col-6">
		          					...
		          					<div class="form-group row">
									    <label for="transactionid" class="col-sm-4 col-form-label text-right" style="font-weight: normal;">Transaction ID<span class="text-danger"><strong>*</strong></span></label>
								    	<div class="col-sm-8">
									      <input class="form-control w-75" type="text" name="transactionid" id="transactionid" readonly>
									    </div>
								  	</div>
		          					<div class="form-group row">
								     	<label for="ponumber" class="col-form-label text-right col-sm-4" style="font-weight: normal;">P. O. \ Ref. Number<span class="text-danger"><strong></strong></span></label>
								    	<div class="col-sm-8">
									...
									<div class="form-group row">
									    <label for="transactiondate" class="col-sm-4 col-form-label text-right" style="font-weight: normal;">Date<span class="text-danger"><strong>*</strong></span></label>
								    	<div class="col-sm-8">
									      <input class="form-control w-75" type="date" name="transactiondate" id="transactiondate">
									    </div>


									    {{-- <input class="form-control w-75" type="hidden" name="supplier" id="supplier"> --}}
								  	...
								  	<div class="form-group row">
									    <label for="referencenote" class="col-sm-4 col-form-label text-right" style="font-weight: normal;">Reference Note<span class="text-danger"><strong></strong></span></label>
								    	<div class="col-sm-8">
												        ...
												        <tr>
											        		<th width="36%">
											        			<select class="selectpicker" data-width="100%" data-live-search="true" aria-label="Default select example" name="debitheadname"
															      id="debitheadname">
															      	<option value="option_select" disabled selected>Select Suplier Account Name</option>
