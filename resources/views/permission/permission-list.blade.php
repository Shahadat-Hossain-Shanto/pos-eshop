            ...
            <div class="row">
	          	<div class="col-lg-12">
		              ...
		              <div class="card-body">
	                	...
	                	<a href="/permission-create"><button type="button" class="btn btn-outline-info"><i class="fas fa-plus"></i> Create Permission</button></a>
...
{{-- {{$permission->group_name}} --}}
				<div class="form-group mb-3">
				   ...
				   <select class="selectpicker" data-width="100%" data-live-search="true" name="permission_group" id="edit_permission_group">
...
@section('script')
<script type="text/javascript" src="js/permission-list.js"></script>
