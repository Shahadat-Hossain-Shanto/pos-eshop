	          				...
	          				<div class="container">
								...
								{{ csrf_field() }}
									<div class="form-group">
									    <label for="group_name" class="form-label" style="font-weight: normal;">Permission Group Name<span class="text-danger"><strong>*</strong></span></label>
									    <input type="text" class="form-control w-50" name="group_name" id="group_name" placeholder="e.g. Apllication Settings">
...
@section('script')
<script type="text/javascript" src="{{asset('js/permission-group.js')}}"></script>
