            ...
            <div class="row">
	          	<div class="col-lg-12">
		              ...
		              <div class="card-header">
		                	<h5 class="m-0"><strong><i class="fas fa-clipboard-list"></i> Permissions Groups</strong></h5>
		              </div>
		              <div class="card-body">
						...
						<a href="/permission-group-add"><button type="button" class="btn btn-outline-info"><i class="fas fa-plus"></i> Create Permission Group</button></a>
...
<!-- Edit Vat Modal -->
<div class="modal fade" id="EDITPermissionGroupMODAL" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
<div class="modal fade" id="DELETEPermissionGroupMODAL" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  	<div class="modal-dialog" role="document">
    	<div class="modal-content">
...
@section('script')
<script type="text/javascript" src="js/permission-group.js"></script>
