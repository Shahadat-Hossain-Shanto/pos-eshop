                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h5 class="m-0"><strong><i class="fas fa-file-contract"></i>Journal Voucher Report</strong></h5>
                            </div>
                            <div class="card-body">
                                <div id="form_div">
                                ...
                                <div id="tablePart" >
                                    <hr>
                                    <h5 class="pb-3"><strong><u>Journal Voucher History</u></strong></h5>
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#journalVoucherReportForm').on('submit', function(e) {
                var transaction_type = 'Journal Voucher';
               ...
               if (transaction_id !=''|| startdate.length != 0 && enddate.length != 0) {
                ...
                $.ajax({
                    type: "get",
                    url: "/journal-voucher-report/"+transaction_id+"/"+startdate+"/"+enddate+"/"+transaction_type,
